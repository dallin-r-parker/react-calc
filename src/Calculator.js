...
class Calculator extends Component{
	...
	setDisplay(num){
		let newNum = (this.state.display === '0' ? num : this.state.display + num)
		this.setState({display: (this.state.display.length < 13) ? newNum : this.state.display})
	}
			...
			<div id="calculator-container">
				...
				<div id="calculator-mask" className="remove-highlight">
					<div className="output">
						<span className="total" style={{color: 'green'}}>{this.state.display}</span>
					</div>
